...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '$nb_i+1 . "\n"', '$nb_i=rand(500,1000); $t="["; for($i=0;$i<$nb_i;$i++){     $t=$t . strval(rand(0,999)) . ", "; } $t=$t . strval(rand(0,999)) . "]"; ', '', '"tableau=$t"', 'print(0)', '');
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '$nb_pair . "\n"', '$nb_i=rand(500,1000); $nb_pair=0; $t="["; for($i=0;$i<$nb_i;$i++){     $nb_r=strval(rand(0,999));     if($nb_r%2==0) $nb_pair++;     $t=$t . $nb_r . ", "; } chop($t, ", "); $t=$t . "]";  ', '', '"tableau=$t"', 'print(0)', '');
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '$nb_somme . "\n"', '$nb_i=rand(500,1000); $nb_somme=0; $t="["; for($i=0;$i<$nb_i;$i++){     $nb_r=strval(rand(0,999));     $nb_somme+=$nb_r;     $t=$t . $nb_r . ", "; } chop($t,", "); $t=$t . "]";  ', '', '"tableau=$t"', 'print(0)', '');
...
[999]-[998] = -587
[1000]-[999] = -225
"', '', '', '"tableau=[286, 679, 397, 494, 150, 23, 252, 277, 639, 62, 563, 430, 19, 934, 848, 117, 926, 753, 317, 94,\
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '$rep . "\n"', '$tab=rand(0,100); $rep=$tab; for ($i=0;$i<10;$i++){   $tab=$tab . ", " . rand(0,100); } ', '', '"numeros=[$tab]"', '', '');
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '$rep . "\n"', '$tab=rand(0,100); for ($i=0;$i<2;$i++){   $tab=$tab . ", " . rand(0,100); } $rep="[$tab]"; for ($i=0;$i<10;$i++){   $tab=$tab . ", " . rand(0,100); }  ', '', '"numeros=[$tab]"', '', '');
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '$rep . "\n"', '$tab=rand(0,100); $tab1=""; for ($i=0;$i<8;$i++){   $tab1=$tab1 . ", " . rand(0,100); }  $rep="[" . substr("$tab1]",2); $tab=$tab . $tab1; for ($i=0;$i<10;$i++){   $tab=$tab . ", " . rand(0,100); } ', '', '"numeros=[$tab]"', '', '');
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '$rep . "\n"', '$tab=rand(0,100); for ($i=0;$i<rand(3,10);$i++){   $tab=$tab . ", " . rand(0,100); }  $tab1=rand(0,100); for ($i=0;$i<3;$i++){   $tab1=$tab1 . ", " . rand(0,100); }  $rep="[$tab1]"; ', '', '"numeros=[$tab,  $tab1]"', '', '');
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '$rep . "\n"', '$tab=rand(0,100); $rep=$tab; for ($i=0;$i<rand(3,10);$i++){   $num=rand(0,100);   $tab=$tab . ", " . $num;   $rep=$num . ", " . $rep; }  $rep="[$rep]"; ', '', '"numeros=[$tab]"', '', '');
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '$rep . "\n"', '$tab=rand(0,100); for ($i=0;$i<4;$i++){   $num=rand(0,100);   $tab=$tab . ", " . $num; } $rep=$tab . ", 17, 42, 25, "; $tab1=rand(0,100); for ($i=0;$i<4;$i++){   $num=rand(0,100);   $tab1=$tab1 . ", " . $num; } $rep=$rep . $tab1;  $rep="[$rep]"; ', '', '"numeros=[$tab, $tab1]"', '', '');
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '$rep . "\n"', 'echo   $n=rand(4,8); $tab=rand(0,100); for ($i=0;$i<$n;$i++){   $num=rand(0,100);   $tab=$tab . ", " . $num; } $rep=$tab . ", 17, 42, 25, "; $tab1=rand(0,100); for ($i=0;$i<$n;$i++){   $num=rand(0,100);   $tab1=$tab1 . ", " . $num; } $rep=$rep . $tab1;  $rep="[$rep]"; ', '', '"numeros=[$tab, $tab1]"', '', '');
