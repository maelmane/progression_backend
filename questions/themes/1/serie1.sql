...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '"Bonjour le monde!"', '$r=rand(0,1000); ', '', '', 'print(42)', ''); 
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '\$somme', '$r=rand(0,1000); $s=rand(0,1000); $somme=$r+$s; ', '', '"alpha=\$r\nbeta=\$s"', 'print(42)', ''); 
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '\$reponse', '$r=rand(0,1000); $reponse=2*$r; ', '', '"alpha=\$r"', 'print(42)', ''); 
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '"La somme de \$r et \$s est \$reponse"', '$r=rand(0,1000); $s=rand(0,1000); $reponse=$r+$s; ', '', '"alpha=\$r\nbeta=\$s"', 'print(42)', ''); 
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '\$entree[0]', '$entree=explode("\r\n",$_POST["stdin"]); if($entree[0]==0){   $entree[0]=rand(0,999); } if($entree[1]==0){   $entree[1]=rand(0,999); }  if($_POST[\'stdin\']==\'\') $_POST[\'stdin\']=$entree[0]; ', '', '', 'print(42)', ''); 
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), 'intval(\$entree[0])*2', '$entree=explode("\n",$_POST["stdin"]); if($entree[0]==\'\'){   $entree[0]=rand(0,999); }  if($_POST[\'stdin\']==\'\') $_POST[\'stdin\']=$entree[0];   ', '', '', 'print(42)', ''); 
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), 'intval(\$entree[0])*2+intval(\$entree[1])*3', '$entree=explode("\r\n",$_POST["stdin"]); if($entree[0]==0){   $entree[0]=rand(0,999); } if($entree[1]==0){   $entree[1]=rand(0,999); }  if($_POST[\'stdin\']==\'\') $_POST[\'stdin\']="$entree[0]\r\n$entree[1]";  ', '', '', 'print(42)', ''); 
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '\$entree[0]. " + " . \$entree[1] . " = " . strval(intval(\$entree[0])+intval(\$entree[1]))', '$entree=explode("\r\n",$_POST["stdin"]); if($entree[0]==0){   $entree[0]=rand(0,999); } if($entree[1]==0){   $entree[1]=rand(0,999); } if($_POST[\'stdin\']==\'\') $_POST[\'stdin\']="$entree[0]\r\n$entree[1]";  ', '', '', 'print(42)', ''); 