...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), 'strtoupper(\$phrase) . "\n"', '$phrase=\'suspendisse eleifend tempor mi non vestibulum sem viverra in mauris placerat facilisis faucibus sed gravida tempus malesuada.\';  ', '', '\"phrase=\\"\$phrase\\"\"', '', ''); 
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '\$phrase[0] . substr(\$phrase,-1) . "\n"', '$lorem=explode(" ",\'suspendisse eleifend tempor mi non vestibulum sem viverra in mauris placerat facilisis faucibus sed gravida tempus malesuada.\'); $mots=array_slice($lorem, rand(0,5), rand(7,12)); $phrase=implode(" ",$mots);  ', '', '\"phrase=\\"\$phrase\\"\"', '', ''); 
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), 'ucfirst(\$phrase) . "\n"', '$lorem=explode(" ",\'suspendisse eleifend tempor mi non vestibulum sem viverra in mauris placerat facilisis faucibus sed gravida tempus malesuada.\'); $phrase=implode(" ",array_slice($lorem, rand(0,5), rand(7,12)));  ', '', '\"phrase=\\"\$phrase\\"\"', '', ''); 
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), 'sizeof(\$mots) . "\n"', '$lorem=explode(" ",\'suspendisse eleifend tempor mi non vestibulum sem viverra in mauris placerat facilisis faucibus sed gravida tempus malesuada.\'); $mots=array_slice($lorem, rand(0,5), rand(7,12)); $phrase=implode(" ",$mots);  ', '', '\"phrase=\\"\$phrase\\"\"', '', ''); 
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), 'strrev(\$phrase) . "\n"', '$lorem=explode(" ",\'suspendisse eleifend tempor mi non vestibulum sem viverra in mauris placerat facilisis faucibus sed gravida tempus malesuada.\'); $mots=array_slice($lorem, rand(0,5), rand(7,12)); $phrase=implode(" ",$mots);  ', '', '\"phrase=\\"\$phrase\\"\"', '', ''); 
...
INSERT INTO question_prog (questionID, reponse, setup, pre_exec, pre_code, in_code, post_code) VALUES ((SELECT max(questionID) FROM question), '\$phrase . "\n"', '$lorem=explode(" ",\'suspendisse eleifend tempor mi non vestibulum sem viverra in mauris placerat facilisis faucibus sed gravida tempus malesuada.\'); $mots=array_slice($lorem, rand(0,5), rand(7,12)); $phrase=implode(" ",$mots); $reponse=implode(" ",array_reverse($mots));  ', '', '\"phrase=\\"\$phrase\\"\"', '', ''); 
