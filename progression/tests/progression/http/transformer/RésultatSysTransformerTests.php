...
final class RésultatSysTransformerTests extends TestCase
{
	public function test_étant_donné_une_RéponseSys_instanciée_avec_des_valeurs_lorsquon_récupère_son_transformer_on_obtient_un_objet_json_correspondant()
	{
		$_ENV["APP_URL"] = "https://example.com/";
		$résultatSysTransformer = new RésultatSysTransformer();

		$résultat = new RésultatSys("Bonjour\nBonjour\n", true, "Bon travail!", 15);
		$résultat->numéro = 0;
		$résultat->id =
			"bob" .
		...
		$réponse_observée = $résultatSysTransformer->transform($résultat);
