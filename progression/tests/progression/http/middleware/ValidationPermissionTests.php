...
final class ValidationPermissionsTests extends TestCase
{
	...
	public function test_étant_donné_un_utilisateur_non_connecté_lorsquon_demande_une_ressource_pour_null_on_obtient_erreur_403()
	{
		$mockRequest = Mockery::mock("Illuminate\Http\Request");
		$mockRequest
			->allows()
	...
	public function test_étant_donné_un_utilisateur_non_connecté_lorsquon_demande_une_ressource_pour_l_utilisateur_existant_bob_on_obtient_erreur_403()
	{
		$mockRequest = Mockery::mock("Illuminate\Http\Request");
		$mockRequest
			->allows()
