...
use progression\domaine\entité\{TentativeSys, Avancement, Question};
use progression\dao\DAOFactory;
use progression\dao\tentative\TentativeDAO;
use PHPUnit\Framework\TestCase;
use Mockery;

final class SauvegarderTentativeSysIntTests extends TestCase
{
	...
	public function test_étant_donné_une_première_tentative_ratée_lorsquon_la_sauvegarde_on_obtient_la_tentative()
	{
		...
		$interacteur = new SauvegarderTentativeSysInt();
