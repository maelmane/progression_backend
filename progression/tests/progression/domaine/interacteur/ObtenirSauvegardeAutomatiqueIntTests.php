...
final class ObtenirSauvegardeAutomatiqueIntTests extends TestCase
{
	...
	public function test_étant_donné_le_username_dun_utilisateur_inexistant_lorsquon_appelle_get_sauveagerde_on_obtient_un_objet_null()
	{
    ...
    public function test_étant_donné_luri_dune_question_inexistante_lorsquon_appelle_get_sauveagerde_on_obtient_un_objet_null()
	{
		$interacteur = new ObtenirSauvegardeAutomatiqueInt();
		$résultat_obtenu = $interacteur->get_sauvegarde_automatique(
			"jdoe",
    ...
    public function test_étant_donné_luri_dune_question_existante_un_username_existant_et_le_bon_langage_lorsquon_appelle_get_sauveagerde_on_obtient_un_objet_sauvegarde_correspondant()
	{
		$interacteur = new ObtenirSauvegardeAutomatiqueInt();
		$résultat_obtenu = $interacteur->get_sauvegarde_automatique(
			"jdoe",
