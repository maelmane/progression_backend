...
final class ChargeurQuestionFichierTests extends TestCase
{
	...
	public function test_étant_donné_un_uri_de_fichier_yaml_invalide_lorsquon_charge_la_question_on_obtient_une_RuntimeException_err_2()
	{
		...
		try {
			$résultat_obtenu = (new ChargeurQuestionFichier())->récupérer_question($uri);
			$this->fail();
		} catch (RuntimeException $résultat_obtenu) {
			$this->assertEquals("Le fichier ${uri} ne peut pas être chargé. (err:1)", $résultat_obtenu->getMessage());
		}
	}

	public function test_étant_donné_un_uri_de_fichier_question_invalide_lorsquon_charge_la_question_on_obtient_une_RuntimeException_err_1()
	{
	...
	public function test_étant_donné_un_uri_de_fichier_non_existant_lorsquon_charge_la_question_on_obtient_une_RuntimeException()
	{
