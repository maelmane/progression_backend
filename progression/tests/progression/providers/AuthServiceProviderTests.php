...
final class AuthServiceProviderCtlTests extends TestCase
{
	...
	{
		$ressources = json_encode(["ressources" => ["url" => ["*"], "method" => "POST"]]);
		$expiration = 0;
		$token = GénérateurDeToken::get_instance()->générer_token("utilisateur_lambda", $expiration, $ressources);
		$method = "GET";
		$route = "/user/utilisateur_lambda";
	...
	{
		$ressources = json_encode(["ressources" => ["url" => ["user/autre_utilisateur"], "method" => "GET"]]);
		$expiration = 0;
		$token = GénérateurDeToken::get_instance()->générer_token("utilisateur_lambda", $expiration, $ressources);
		$method = "GET";
		$route = "/user/utilisateur_lambda";
	...
	{
		$ressources = json_encode(["ressources" => ["url" => ["user/*"], "method" => "GET"]]);
		$expiration = 0;
		$token = GénérateurDeToken::get_instance()->générer_token("utilisateur_lambda", $expiration, $ressources);
		$method = "GET";
		$route = "/user/utilisateur_lambda";
	...
	{
		$ressources = json_encode(["ressources" => ["url" => ["avancement/*"], "method" => "GET"]]);
		$expiration = 0;
		$token = GénérateurDeToken::get_instance()->générer_token("utilisateur_lambda", $expiration, $ressources);
		$method = "GET";
		$route = "/user/utilisateur_lambda";
