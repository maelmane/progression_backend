...
class ProgCtl extends Controleur {
	...
	function __construct( $source, $user_id ){
		...
		$this->à_exécuter=isset( $_REQUEST[ "exécuter" ] ) && isset( $_REQUEST[ "incode" ] ) && $_REQUEST[ "incode" ]!="";
		$this->reponse=isset( $_REQUEST[ "reponse" ] ) &&  $_REQUEST[ "reponse" ]!="" ?$_REQUEST[ "reponse" ]:null;
		$this->reset=isset( $_REQUEST[ "reset" ] ) &&  $_REQUEST[ "reset" ]!="" ?$_REQUEST[ "reset" ]:null;
		$this->langid=isset( $_REQUEST[ "langid" ] )&& $_REQUEST[ "langid" ]!="" ?$_REQUEST[ "langid" ]:null;
		$this->incode=isset( $_REQUEST[ "incode" ] ) &&  $_REQUEST[ "incode" ]!="" ?$_REQUEST[ "incode" ]:null;
		$this->params=isset( $_REQUEST[ "params" ] ) &&  $_REQUEST[ "params" ]!="" ?$_REQUEST[ "params" ]:null;
		$this->stdin=isset( $_REQUEST[ "stdin" ] ) &&  $_REQUEST[ "stdin" ]!="" ?$_REQUEST[ "stdin" ]:null;
	}
	...
	protected function calculer_sorties( $sorties ){
		...
		return array( "output"=>$this->resume( $sorties[ "stdout" ], 21 ),
