...
use progression\domaine\interacteur\{ObtenirQuestionSysInt,
        ObtenirAvancementSysInt,
        RéinitialiserConteneurInt,
        ConnecterConteneurInt,
        TraiterRésultatsSysInt,
        SauvegarderAvancementSysInt};
