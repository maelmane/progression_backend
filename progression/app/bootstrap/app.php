...
$app->singleton(Illuminate\Contracts\Debug\ExceptionHandler::class, progression\exceptions\Handler::class);

$app->singleton(Illuminate\Contracts\Console\Kernel::class, progression\console\Kernel::class);
...
//$app->middleware([
//    progression\http\middleware\Authenticate::class
//]);
...
$app->middleware([progression\http\middleware\Cors::class]);
