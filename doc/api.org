...
|        |             | avancements | liste d'Avancement |                  |
|--------+-------------+-------------+--------------------+------------------|
...
| catégories             | liste de sous-catégories                               |
| questions              | liste de Questions                                     |
| pourcentage_avancement | pourcentage d'avancement dans cette catégorie          |
| accessibilité          | Vrai si la catégorie est accessible pour l'utilisateur |
...
| │                            |               | type        | int                                  |         |
| ├ QuestionProg               |               |             |                                      |       3 |
| │                            |               | ébauches    | liste d'ébauches de Solution         |         |
...
| accessibilité | Vrai si la question est accessible pour l'utilisateur courant |
...
curl https://progression.dti.crosemont.quebec/api/v1/user?embed=true -H "Authorization: Bearer $TOKEN"
#+END_SRC
...
:   "_embedded": {
:     "avancements": [
:       "programmation_1/les_fonctions/appeler_une_fonction": {
:         "état": 1,
:         "solutions" : []
:       },
:       "programmation_1/les_fonctions/appeler_une_autre_fonction": {
:         "état": 1,
:         "solutions" : []
:       },
:     ]
...
curl https://progression.dti.crosemont.quebec/api/v1/user?links=true -H "Authorization: Bearer $TOKEN"
#+END_SRC
...
:   "_links": {
:     "self": {
:       "href": "https://progression.dti.crosemont.quebec/api/v1/user"
:     },
:     "catégories": {
:       "href": "https://progression.dti.crosemont.quebec/api/v1/user/test/catégories"
:     }
:   }
: }
...
:     "catégories": ["les_boucles", "les_fonctions"],
:     "questions": []
:   },
:   "_links": {
:     "self": {
:       "href": "https://progression.dti.crosemont.quebec/api/v1/catégorie/programmation_1"
:     },
:     "parent": {
:       "href": "https://progression.dti.crosemont.quebec/api/v1/user/test"
:     },
:     "catégories": {
:       "href": "https://progression.dti.crosemont.quebec/api/v1/catégorie/programmation_1/catégories"
:     },
:     "questions": {
:        "href": "https://progression.dti.crosemont.quebec/api/v1/catégorie/programmation_1/questions"
:     },
:     "pourcentage_avancement": {
:       "href": "https://progression.dti.crosemont.quebec/api/v1/user/test/catégorie/programmation_1/pourcentage_avancement"
:     },
:     "accessibilité": {
:       "href": "https://progression.dti.crosemont.quebec/api/v1/user/test/catégorie/programmation_1/accessibilité"
:     }
:   }
: }
...
:     "description": "Exercices d'introduction aux fonctions.",
:     "catégories": [],
:     "questions": ["appeler_une_fonction"]
:   },
:   "_links": {
:     "self": {
:       "href": "https://progression.dti.crosemont.quebec/api/v1/catégorie/programmation_1/les_fonctions/"
:     },
:     "parent": {
:       "https://progression.dti.crosemont.quebec/api/v1/catégorie/programmation_1"
:     },
:     "catégories": {
:       "href": "https://progression.dti.crosemont.quebec/api/v1/catégorie/programmation_1/les_fonctions/catégories",
:     },
:     "questions": {
:       "href": "https://progression.dti.crosemont.quebec/api/v1/catégorie/programmation_1/les_fonctions/catégories"
:     },
:     "pourcentage_avancement": {
:       "href": "https://progression.dti.crosemont.quebec/api/v1/user/test/catégorie/programmation_1/les_fonctions/pourcentage_avancement"
:     },
:     "accessibilité": {
:       "href": "https://progression.dti.crosemont.quebec/api/v1/user/test/catégorie/programmation_1/les_fonctions/accessibilité"
:     }
:   }
: }
...
#+BEGIN_SRC sh :eval never
curl --data '{"code":"ma_fonction(\"Allo le monde\")"  }' https://progression.dti.crosemont.quebec/api/v1/user/test/question/programmation_1/les_fonctions/appeler_une_fonction/avancement/solutions?langage=python -H "Authorization: Bearer $TOKEN"
#+END_SRC

** Obtenir une solution soumise pour la question «appeler_une_fonction» :

#+BEGIN_SRC sh :eval never
curl https://progression.dti.crosemont.quebec/api/v1/user/test/solution/programmation_1/les_fonctions/appeler_une_fonction/1612834148 -H "Authorization: Bearer $TOKEN"
#+END_SRC
