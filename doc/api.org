...
#+RESULTS:
: {"token":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjp7InVzZXJuYW1lIjoiamRvZSIsInJvbGUiOjAsImlkIjo3LCJhY3RpZiI6bnVsbH0sImN1cnJlbnQiOjE2MTMwNzE3OTQsImV4cGlyZWQiOjE2MTMxNTgxOTR9.epf3-B6HvXwxconriMoCXhD533moQ8yWgWOyAkaCBgQ"}

** Obtenir le profil de l'utilisateur connecté ~jdoe~ et ses avancements :

#+BEGIN_SRC sh :eval no :var TOKEN=get_token :results output
