...
curl -X POST --data "$DATA" "https://progression.dti.crosemont.quebec/api/v1/user/jdoe/cles -H "Authorization: Bearer $TOKEN"
#+END_SRC
...
curl -X POST --data "$DATA" "https://progression.dti.crosemont.quebec/api/v1/auth -H "Authorization: Bearer $TOKEN"
#+END_SRC
