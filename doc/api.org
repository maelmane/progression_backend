...
|-------------+--------+--------------------+-----------------------------------------------------------|
| numéro      | string |                    | numéro unique de la clé                                   |
| création    | date   |                    | date de création                                          |
| expriration | date   |                    | date d'expiration, 0=n'expire jamais                      |
