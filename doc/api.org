...
| Nom      | Cardinalité | Type    | description                  |
|----------+-------------+---------+------------------------------|
| ébauches | 1-n         | Ébauche | liste d'ébauches de Solution |
...
** Soumettre une tentative de solution à la question «appeler_une_fonction» : ~PROTOTYPE~
...
** Obtenir une tentative de solution préalablement soumise pour la question «appeler_une_fonction» : ~PROTOTYPE~
