...
$r1=rand(0,1000);
$r2=rand(0,1000);
execute("Question 4", "Utilisez les fonctions <code>afficher_nb1</code> et <code>afficher_nb2</code> pour faire afficher les deux nombres dans l'ordre le nombre 2 puis le nombre 1", "$r2\n$r1", "5oj8GlXnGI", "
def afficher_nb1():
    \"\"\"
